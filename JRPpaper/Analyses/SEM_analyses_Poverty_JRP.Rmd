...
data=full_join(scales_INR,ddparams, by=c("subID"))
missing=anti_join(scales_INR,ddparams, by=c("subID"))
```
...
plan_cfa_g = cfa(plannfulness, data = data, group = 'inc_group')
plan_cfa_g_loadings = cfa(plannfulness, data = data, group = 'inc_group', group.equal = 'loadings') 
